...
public class UrlVar {
    ...
    public static final String URL_registrar_categorias = "https://jamt29.000webhostapp.com/main_class.php";
    ...
    public static final String URL_consultaAllCategorias = "https://jamt29.000webhostapp.com/main_class.php";
    //URL para registrar productos nuevos.
    public static final String URL_registrar_productos = "https://jamt29.000webhostapp.com/guardar.php";
    //URL consulta de productos registrados por categoria (doble tabla)
    public static final String URL_consulta_catproducto = "https://jamt29.000webhostapp.com/main_class.php";
